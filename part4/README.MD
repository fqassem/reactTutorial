...
This is our root reducer - a reducer that combines all of our other reducers used to initialize our store. As we define more reducers, we'll add them to this file. 
