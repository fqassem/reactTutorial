...
Also notice that we have a placeholder div that contains the words 'Loading gif' that shows when `isFetching` is true. When we update our application with CSS, we'll replace with something nicer.
