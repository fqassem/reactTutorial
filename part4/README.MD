...
We also have a `componentWillMount` in this page. If the user is already signed in (meaning they have a role), we will forward them to the Home Page. This is so that signed-in users can't sign-in again.
